...
public class ApplicationsController extends BaseController {
    ...
    //                         Model models) {
    //    return servicesController.index(app, null, null, null, request, response, models);
    //}
    ...
    //                             Model models) {
    //    return servicesController.route(serviceName, type, app, null, request, response, models);
    //}
    ...
    //                   HttpServletRequest request, HttpServletResponse response, Model models) {
    //    index(service, address, application, keyword, request, response, models);
    //
    //    //Set<String> newList = new HashSet<String>();
